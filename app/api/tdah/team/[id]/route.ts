...
// =====================================================
// AXIS TDAH - API: Gestão Individual de Membro
// Mesma lógica do ABA (profiles compartilhados)
// =====================================================

/**
 * PATCH /api/tdah/team/[id]
...
export async function PATCH(
  ...
  try {
    ...
    const result = await withTenant(async (ctx) => {
      ...
      // Audit log
      const metadata: Record<string, unknown> = { target_profile_id: memberId, source: 'tdah' }
      if (role !== undefined) {
...
/**
 * DELETE /api/tdah/team/[id]
 * Desativar membro (soft delete).
 * Acesso: admin apenas.
 * NOTA: TDAH não tem learner_therapists — vínculo é via created_by.
 * Pacientes criados pelo membro desativado permanecem acessíveis por admin/supervisor.
 */
